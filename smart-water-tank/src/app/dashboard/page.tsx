...
export default function Dashboard() {
  ...
  const router1 = useRouter(); // ✅ Step 2: Initialize router
  

  return (
    <div className="relative min-h-screen w-full bg-gradient-to-br from-white via-gray-100 to-white text-gray-800 flex justify-center items-center p-6 overflow-hidden">
